...
public class ShootKickIndexCommand extends Command {
    ...
    private final ShooterFlywheel shooter;
    private final Kicker kicker;
    //private final Conveyor indexer;
    private final Conveyor agitator;
   ...
   // private final InterpolatingDoubleTreeMap calculatedHoodAngle = new InterpolatingDoubleTreeMap();
    ...
    public ShootKickIndexCommand(
        ...
        addRequirements(this.shooter, this.kicker, this.agitator);
    }
    ...
    public void execute() {
       ...
       // agitator.setDutyCycleSetpoint(0.7);//RPM.of(1135)
        ...
        if (shooterReady) {
           ...
           agitator.setDutyCycleSetpoint(0.1);
        } else {
            agitator.setDutyCycleSetpoint(-0.1);
        }
