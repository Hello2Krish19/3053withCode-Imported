...
//                              );
    ...
    Command shootCommand = new ShootKickIndexCommand(shooterFlywheel, kicker, conveyor, RPM.of(3000));



    driverXbox.x().whileTrue(intakeArm.setDegreeCommand(0));

    

    driverXbox.rightTrigger(0.2).whileTrue(shootCommand);
