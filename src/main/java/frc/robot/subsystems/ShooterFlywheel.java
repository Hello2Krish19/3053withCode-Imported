...
public class ShooterFlywheel extends SubsystemBase {
    ...
    private final TalonFX flywheelMotor = new TalonFX(Constants.shooterFlywheelMotorID);
    private final TalonFX flywheelFollowerMotor = new TalonFX(Constants.shooterFlywheelFollowerMotorID);
